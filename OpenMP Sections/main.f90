...
IMPLICIT NONE
   ...
   !Tratamento tarefas independentes
...
DO WHILE (time .LT. final_time)
    ...
    !!-------- pseudo-time calculation starts ---------------------------------------------------
     ...
     !!-------- Solve Momentum Equation with QUICK Scheme Original
	...
	!$omp section      
            CALL solve_U0(um,vm,um_n,um_tau,vm_tau,um_n_tau,pn,residual_u, Ru, ui)
        !$omp section    
            CALL solve_V0(um,vm,vm_n,um_tau,vm_tau,vm_n_tau,pn,T,InvFr2,residual_v, Rv, vi)
    	!$omp end parallel sections

	!$omp parallel sections
	!$omp section 
	    CALL solve_U1(um,vm,um_n,um_tau,vm_tau,um_n_tau,pn,residual_u, Ru, ui)
	!$omp section   
            CALL solve_V1(um,vm,vm_n,um_tau,vm_tau,vm_n_tau,pn,T,InvFr2,residual_v, RV, vi)
	!$omp end parallel sections
	
	!$omp parallel sections 
	!$omp section 
            CALL solve_U2(um,vm,um_n,um_tau,vm_tau,um_n_tau,pn,residual_u, Ru, ui)
	!$omp section   
            CALL solve_V2(um,vm,vm_n,um_tau,vm_tau,vm_n_tau,pn,T,InvFr2,residual_v, Rv, vi)
	!$omp end parallel sections
