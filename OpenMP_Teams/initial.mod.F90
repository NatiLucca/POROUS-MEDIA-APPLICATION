...
#line 1 "/home/nati/poros_openmp_teams/initial.f90"
SUBROUTINE init
    USE comum
    IMPLICIT NONE
    
!-------- iterations values -------------    
      include 'initial.f90.opari.inc'
#line 6 "/home/nati/poros_openmp_teams/initial.f90"
...
SUBROUTINE IC(um,vm,p,T)
    ...
    IMPLICIT NONE
      include 'initial.f90.opari.inc'
#line 24 "/home/nati/poros_openmp_teams/initial.f90"
    INTEGER :: i, j
...
SUBROUTINE restart(um,vm,p,T)
    ...
    IMPLICIT NONE
      include 'initial.f90.opari.inc'
#line 71 "/home/nati/poros_openmp_teams/initial.f90"
    INTEGER :: i, j
    REAL(8), DIMENSION(1:imax+1,1:jmax  ) :: um
    REAL(8), DIMENSION(1:imax  ,1:jmax+1) :: vm
...
SUBROUTINE restart_dom(um,vm,p,T,Z,H)
    ...
    IMPLICIT NONE
      include 'initial.f90.opari.inc'
#line 123 "/home/nati/poros_openmp_teams/initial.f90"
    INTEGER :: i, j
