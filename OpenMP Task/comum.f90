MODULE comum
   ...
   !     REAL(8)  :: Darcy_term
        ...
        INTEGER, PARAMETER :: imax  = 200 !200 !100 !51 !numero de pontos da malha em x
...
!        REAL(8)                :: q_dim = 47904.1916d3        ! q    = combustion heat [J/kg] for n-Heptane C7H16
 ...
 !Temporários adicionados por Claudio em 01.06.2021
    ...
    !Temporários adicionados por Claudio em 16.06.2021
    !de solve_P
...
!$omp declare target(beta,max_vel, imax, jmax, v_i, S, Tsup, Lf, q, Re, Pr, Pe, b_art, dtau,dt, c2,&
!$omp& residual_p, residual_u,residual_v, InvFr2, itc, error, time, dt, final_time)
